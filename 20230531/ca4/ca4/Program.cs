// Poder gestinar diferentes tipos de coleccion (Product, Fruit, ...)
// Poder guardar en diferentes repositorios (memory, files, database, service, ...)
// Se pueda distruir o reutilizar los repositorios
